...
func (app *Application) AddToCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if userQueryID == "" {
			...
			_ = c.AbortWithError(http.StatusBadRequest, errors.New("iser id is empty"))
			return
		}
...
func GetItemFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		grouping := bson.D{{Key: "$groupind", Value: bson.D{primitive.E{Key: "_id", Value: "$_id"}, {Key: "total", Value: bson.D{primitive.E{Key: "$sum", Value: "$usercart.price"}}}}}}

...
var UserCollection *mongo.Collection = database.UserData(database.Client, "Product")
...
func SearchProduct() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, "something went wrong, please tey after some time")
			return
		}
